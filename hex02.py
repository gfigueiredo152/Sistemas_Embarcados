...
def convert_and_print_steps(decimal_num, base):
    ...
    while decimal_num > 0:
        remainder = decimal_num % base
        steps.append(f"{decimal_num} = {decimal_num} - {digits[remainder]}*{base}^{len(steps)}")
        decimal_num //= base
...
#================== hexadecimal ======================================
    if choice == '1':
        ...
        hexadecimal = decimal_to_base(decimal_input, 16) # Guarda o valor de entrada e valor da converção. 
